    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box
        sx={{
          ...
          px: { xs: 2, md: 4 },
          textAlign: 'center',
          backgroundColor: isDarkMode ? 'rgba(15, 118, 110, 0.06)' : 'rgba(20, 184, 166, 0.04)',
          borderTop: '1px solid rgba(15, 118, 110, 0.1)',
          borderBottom: '1px solid rgba(15, 118, 110, 0.1)',
        }}
      >
        <Typography variant="h5" sx={{ mb: 0.5, fontWeight: 700, color: '#0f766e' }}>
          🚀 Quick Access for Development
        </Typography>
        <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2.5 }}>
          Click a role below to go directly to the login page with credentials pre-filled.
        </Typography>
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} justifyContent="center" sx={{ mb: 2 }}>
          {/* Manager Login */}
          <Button
            variant="contained"
            onClick={() => navigate('/login', { state: { prefillEmail: 'manager@hivedeliver.com', prefillPassword: 'manager123' } })}
            sx={{
              px: 3,
              py: 1.5,
              textTransform: 'none',
          ...
          <Button
            variant="outlined"
            onClick={() => navigate('/login', { state: { prefillEmail: 'user@hivedeliver.com', prefillPassword: 'user123' } })}
            sx={{
              px: 3,
              py: 1.5,
              textTransform: 'none',
        ...
        <Typography variant="caption" sx={{ color: 'text.secondary', display: 'block' }}>
          Manager: manager@hivedeliver.com / manager123 &nbsp;|&nbsp; SME User: user@hivedeliver.com / user123
        </Typography>
      </Box>
