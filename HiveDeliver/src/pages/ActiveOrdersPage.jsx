...
const initialActiveOrders = [
  ...
  {
    id: 'P205',
    recipient: 'Lim Chee Keong',
    address: 'Block B, Residensi Greenfield, Kepong, Kuala Lumpur',
    weight: '1.5 kg',
    drone: 'H2',
    battery: 55,
    status: 'Dispatched',
    eta: 31,
    distance: '9.8 km',
    coords: '3.2188° N, 101.6382° E',
    dispatchedAt: '2026-03-18 14:35:00',
  },
  {
    id: 'P206',
    recipient: 'Nurul Ain Binti Razak',
    address: 'Jalan Ampang Hilir, Ampang, Kuala Lumpur',
    weight: '0.6 kg',
    drone: 'H5',
    battery: 83,
    status: 'In Flight',
    eta: 6,
    distance: '1.9 km',
    coords: '3.1612° N, 101.7488° E',
    dispatchedAt: '2026-03-18 14:28:00',
  },
  {
    id: 'P207',
    recipient: 'Rajesh Kumar',
    address: 'No. 14, Jalan Masjid India, Kuala Lumpur City Centre',
    weight: '2.8 kg',
    drone: 'H7',
    battery: 38,
    status: 'Landing',
    ...
    dispatchedAt: '2026-03-18 13:50:00',
  },
  {
    id: 'P208',
    recipient: 'Fatimah Zahra',
    address: 'Lot 22, Taman Desa Jaya, Kepong, Selangor',
    weight: '4.0 kg',
    drone: 'H4',
    battery: 71,
    status: 'Dispatched',
    eta: 45,
    distance: '12.3 km',
    coords: '3.2340° N, 101.6210° E',
    dispatchedAt: '2026-03-18 14:40:00',
  },
  {
    id: 'P209',
    recipient: 'Wong Siew Lin',
    address: 'Unit 3A, Menara Bangsar South, Bangsar, Kuala Lumpur',
    weight: '1.1 kg',
    drone: 'H9',
    battery: 90,
    status: 'In Flight',
    eta: 18,
    distance: '4.7 km',
    coords: '3.1102° N, 101.6641° E',
    dispatchedAt: '2026-03-18 14:15:00',
  },
]
