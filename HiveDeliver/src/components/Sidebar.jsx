...
function Sidebar({ onNavigate }) {
  ...
  return (
    <Box
      sx={{ height: "100%", p: 2.2, display: "flex", flexDirection: "column" }}
    >
      <Stack
        direction="row"
        spacing={1.2}
      ...
      >
        ...
        <Stack spacing={0}>
          <Typography
            variant="h6"
            sx={{ lineHeight: 1.1, fontWeight: 800, fontSize: "1.05rem" }}
          >
            {t("common.appName")}
          </Typography>
          <Typography
      ...
      <List sx={{ p: 0, flex: 1 }}>
        {navItems.map((item) => (
          ...
          >
            <ListItemIcon
              sx={{ minWidth: 36, color: "text.secondary", fontSize: "1.1rem" }}
            >
              {item.icon}
            </ListItemIcon>
            <ListItemText
